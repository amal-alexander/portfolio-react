...
// Root route
app.get('/', (req, res) => {
    res.send('✅ Welcome to the SEO Audit, Clustering, and Blog API! Use POST /audit to analyze a URL, GET /api/cluster to get topic clusters, or /posts to manage blog posts.');
});
